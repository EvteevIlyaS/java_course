...
public class Main {
    ...
    private static final Logger logger_input_error = LogManager.getLogger("InputErrorFile");
    private static final Logger logger_info = LogManager.getLogger("SearchFile");
    private static final Logger logger_exception = LogManager.getLogger("ExceptionsFile");
...
//                throw new Exception();
                ...
                logger_exception.error(ex.getMessage());
            }
        }
    }
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            logger_info.info(line + "(ввод)");
            Station station = stationIndex.getStation(line);
            if (station != null) {
                return station;
            }
            logger_input_error.info(line + "(неверный ввод)");
